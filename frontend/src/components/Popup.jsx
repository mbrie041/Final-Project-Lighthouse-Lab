      ...
      <div className='popup_inner'>
        ...
        <section>
          ...
          <div class="about__body">
            <div class="about__body-header col-sm-12">Our Team</div>
            <div class="about__body-body">
              <div class="info col-sm-4">
                <p class="sub-heading">Jacqueline Lee</p>
              ...
              <div class="info col-sm-4">
                <p class="sub-heading">Mike Brierly</p>
              ...
              <div class="info col-sm-4">
                <p class="sub-heading">Ruowen Tang</p>
