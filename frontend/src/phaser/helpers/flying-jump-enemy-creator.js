...
//Function that creates flying and bouncing enemies
...
function createEnemy(
  ...
  //set initial visuals and speeds
  ...
  for (let wall of collisionArray) {
    ...
    colliderArray.push(
      ...
      scene.physics.world.addCollider(createdEnemy.sprite, wall, (sprite) => {
        //checks to see if the enemy is touching the ground and tells it to fly up
